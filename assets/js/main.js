...
function createWindow()
{
  ...
  electronLocalshortcut.register(mainWindow, 'F8', () =>
  {
    mainWindow.webContents.send('shortcut-pressed', 'F8');
  });

  electronLocalshortcut.register(mainWindow, 'F7', () =>
  {
    mainWindow.webContents.send('shortcut-pressed', 'F7');
  });
